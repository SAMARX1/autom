    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton("ᴊᴏɪɴɪɴɢ ᴅᴏɴᴇ🦝", callback_data=f"{pre}#{file_id}")])
            except (IndexError, ValueError):
                btn.append([InlineKeyboardButton("ᴊᴏɪɴɪɴɢ ᴅᴏɴᴇ🦝", url=f"https://t.me/{temp.U_NAME}?start={message.command[1]}")])
        await client.send_message(
            chat_id=message.from_user.id,
            text="**ʙᴇғᴏʀᴇ  ᴜsᴇ  ᴍᴇ,  ᴊᴏɪɴ  ᴍʏ  ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ʟᴀᴛᴇsᴛ  ᴍᴏᴠɪᴇ  ɴᴇᴡs .\n\n ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴊᴏɪɴɪɴɢ ᴅᴏɴᴇ ʙᴜᴛᴛᴏɴ**",
